...
@push('header')
    ...
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,400,700,300&amp;subset=latin,vietnamese" rel="stylesheet" >
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet" >
    <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro" rel="stylesheet" >
    <link href="https://fonts.googleapis.com/css?family=Encode+Sans" rel="stylesheet" >
    <link href="https://fonts.googleapis.com/css?family=Merriweather+Sans" rel="stylesheet" >
    <link href="{{ asset('/themes/8anime/css/bootstrap.min.css') }}?ver={{ config('theme8anime.version') }}" rel="stylesheet" type="text/css" >
    ...
    <script type="text/javascript" src="{{ asset('/themes/8anime/js/jquery-3.6.0.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('/themes/8anime/js/bootstrap.min.js') }}"></script>
    ...
    @endif
    <script type="text/javascript">
        JS_Load('/themes/8anime/js/default.include-footer.js');
    </script>
