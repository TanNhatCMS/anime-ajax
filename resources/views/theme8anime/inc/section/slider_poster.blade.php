                ...
                <div class="TPost D">
                    ...
                    <div class="TPMvCn">
                        ...
                        <div class="Description">
                            <p>{!! mb_substr(strip_tags($movie->content),0,160, "utf-8") !!}...</p>
                        ...
                        <div class="Cast">
                            {!! $movie->actors->map(function ($actor, $key) {
                                if($key < 5) return '<img src="/themes/8anime/images/cast-image.png" alt="Diễn viên '.$actor->name.'" title="Diễn viên '.$actor->name.'">';
                            })->implode(', ') !!}
